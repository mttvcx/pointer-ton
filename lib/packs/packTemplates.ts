...
function bronzeTemplate(): PackTemplate {
  return {
    ...
    maxNormalReturnPctOfPack: 0.46,
    maxJackpotReturnPctOfPack: 1.3,
    ...
    outcomes: [
      ...
      },
      {
        ...
        kind: 'token_reward',
        probabilityBps: 2400,
        minReturnPctOfPack: 0.22,
        maxReturnPctOfPack: 0.33,
        title: 'Momentum clip',
      },
      {
        rarity: 'uncommon',
  ...
  return {
    ...
    outcomes: [
      ...
      },
      {
        ...
        kind: 'legendary_reward',
        probabilityBps: 80,
        minReturnPctOfPack: 0.24,
        maxReturnPctOfPack: 0.35,
        title: 'Legend pull',
      },
      {
        rarity: 'mythic',
