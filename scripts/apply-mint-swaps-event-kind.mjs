/**
 * Applies mint_swaps event_kind migration + PostgREST reload.
...
const ddlPath = resolve(__dirname, 'mint-swaps-event-kind.sql');
...
async function main() {
  ...
  try {
    ...
    console.log('✓ mint_swaps event_kind migration applied');
  } finally {
