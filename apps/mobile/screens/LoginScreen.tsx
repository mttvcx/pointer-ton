...
const s = StyleSheet.create({
  ...
  wordmark: { color: '#fff', fontFamily: 'Sora_700Bold', fontSize: 72, letterSpacing: -2.4 },
  tagline: { color: '#fff', fontFamily: 'Sora_500Medium', fontSize: 24, textAlign: 'center', marginBottom: 20, lineHeight: 31 },
  actions: { gap: 12 },
  ...
  appleText: { color: '#000', fontSize: 17, fontFamily: 'Sora_600SemiBold' },
  ...
  googleText: { color: '#fff', fontSize: 17, fontFamily: 'Sora_600SemiBold' },
  terms: { color: 'rgba(255,255,255,0.96)', fontSize: 12, textAlign: 'center', marginTop: 12, lineHeight: 17, paddingHorizontal: 20, fontFamily: 'Sora_500Medium', ...darkShadow },
});
