    ...
    <View style={s.root}>
      ...
      {q.isLoading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={<Text style={s.empty}>No tokens yet — discovery is throttled while testing.</Text>}
...
const s = StyleSheet.create({
  root: { flex: 1, backgroundColor: colors.bg, padding: 16, paddingTop: 56 },
  h1: { color: colors.fg, fontSize: 26, fontWeight: '800', marginBottom: 12 },
  ...
  avatar: { width: 40, height: 40, borderRadius: 10, backgroundColor: colors.bgSunken },
