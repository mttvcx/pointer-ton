...
export function WalletCompactTooltipPanel({
  ...
  return (
    <div className="z-50 w-[300px] overflow-hidden rounded-lg border border-border-subtle bg-bg-raised p-0 shadow-panel">
      <div className="flex items-center justify-between border-b border-border-subtle/50 px-3 pb-2 pt-2.5">
        <div className="flex min-w-0 items-center gap-1">
      ...
      <div className="grid grid-cols-3 gap-2 border-b border-border-subtle/50 px-3 py-2.5">
        <HeroStat
      ...
      <div className="grid grid-cols-2 gap-2 border-b border-border-subtle/50 px-3 py-2">
        <div className="flex min-w-0 flex-col gap-0.5">
